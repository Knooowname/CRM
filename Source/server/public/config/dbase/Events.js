...
var Events = (function () {
    function Events(_args) {
        this.db = (0, DBase_1.getDB)();
        this.args = _args;
    }
    Events.prototype.get_events_user = function () {
        return __awaiter(this, void 0, void 0, function () {
            var db_response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.db.query("SELECT * FROM events WHERE user_id = " + this.args.user_id + "")];
                    case 1:
                        db_response = _a.sent();
    ...
    Events.prototype.get_events_client = function () {
        return __awaiter(this, void 0, void 0, function () {
            var db_response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.db.query("SELECT * FROM events WHERE client_id = " + this.args.client_id + " ")];
                    case 1:
                        db_response = _a.sent();
                        if (db_response.rows.length !== 0) {
                            return [2, db_response.rows];
    ...
    Events.prototype.add_events = function () {
        return __awaiter(this, void 0, void 0, function () {
            var start_date, end_date, db_response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    Events.prototype.edit_events = function () {
        return __awaiter(this, void 0, void 0, function () {
            var start_date, end_date, db_response;
            return __generator(this, function (_a) {
                switch (_a.label) {
